...
(function() {
  zipper.backup = function(databaseName, includeData, callback) {
    ...
    initializeDatabaseJson = function(db) {
      var databaseJson;
      databaseJson = {};
      databaseJson.name = 'AccountancyApp-' + db.name;
    ...
    showDownloadLink = function(databaseName) {
      ...
      var fileName = (zipper.databaseJson == null ? 'BackUpDB' : zipper.databaseJson.name) + 
        '-' + year + '-' + month + '-' + day + '-' + hour + '-' + minute + '-' + seconds;      
      console.log(fileName);
      tag = $('<a/>').attr({'href':url, 'download':fileName}).text('Download here');
      tag[0].click();
      callback();
    };
